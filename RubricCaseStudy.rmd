...
*Out of 331 observations in GDP Dataset, 5 rows from header were removed as they were invalid and from remaining 326 observatiaons, count of observations missing GDP rank is : `r NAcount`*
...
*We have `r blank_ig_cnt` missing values for Income Group variable in the EDU dataset.*  
...
*In the merged data frame we see Rank variable has `r na_rank` missing values and "Income Group" has `r na_inc_grp` missing values.*
...
* Analysis of GDP and EDU datasets gave below insights
  ...
  * NA Counts in both datasets
    * In GDP Dataset, count of missing values for Rank variable : `r NAcount`
    * In EDU dataset, count of missing values for Income Group variable is : `r blank_ig_cnt`
    * In merged dataset, count of missing values for Rank variable is : `r na_rank`
    * In merged dataset, count of missing values for Income Group variable is : `r na_inc_grp`
